{{-- resources/views/agricultor/reportes/create.blade.php --}}
...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600">
            Pedido #{{ $pedido->id_pedido }} - Cliente: {{ $pedido->cliente->nombre }} {{ $pedido->cliente->apellido }}
        </p>
    </div>

    {{-- Formulario de reporte --}}
    <div class="bg-white rounded-lg shadow-lg p-6">
        <form action="{{ route('agricultor.reportes.store', $pedido->id_pedido) }}" method="POST">
            @csrf
            ...
            <div class="mb-6">
                ...
                <select name="razon" id="razon" required
                    ...
                    <option value="Cliente abusivo">Cliente abusivo o irrespetuoso</option>
                    <option value="Reseña falsa">Reseña falsa o malintencionada</option>
                    <option value="Problema con el pedido">Problema con el pedido o entrega</option>
                    <option value="Contenido inapropiado">Contenido inapropiado en reseñas</option>
                    <option value="Disputas de pago">Disputas relacionadas con el pago</option>
            ...
            <div class="mb-6">
                ...
                <textarea name="descripcion" id="descripcion" rows="5" required
                          placeholder="Describe detalladamente el problema que has experimentado con este pedido..."
